  ...
  return (
    ...
    >
      ...
      <Collapsible title="How it works">
        <ThemedText>
          • On TV platforms, these components have &ldquo;onFocus()&rdquo; and &ldquo;onBlur()&rdquo;
          props, in addition to the usual &ldquo;onPress()&rdquo;. These can be used to
        ...
        <ThemedText>
          ...
          &ldquo;onHoverIn()&rdquo;, and &ldquo;onHoverOut()&rdquo; props.
        </ThemedText>
        <ThemedText>
          • In addition, the functional forms of the Pressable style prop and
          the Pressable content, which in React Native core take a &ldquo;pressed&rdquo;
          boolean parameter, can also take &ldquo;focused&rdquo; as a parameter on TV
          platforms, and &ldquo;hovered&rdquo; as a parameter on web.
        </ThemedText>
        <ThemedText>
        ...
        <ThemedText>
          ...
          &ldquo;focus&rdquo;, &ldquo;blur&rdquo;, &ldquo;pressIn&rdquo;, and &ldquo;pressOut&rdquo; events directly from native
